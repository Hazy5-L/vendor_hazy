...
bootanimation_sizes := $(subst .zip,, $(shell ls vendor/hazy/prebuilt/common/bootanimation))
...
PRODUCT_COPY_FILES += \
    vendor/hazy/prebuilt/common/bootanimation/halfres/$(TARGET_BOOTANIMATION_NAME).zip:system/media/bootanimation.zip
else
PRODUCT_COPY_FILES += \
    vendor/hazy/prebuilt/common/bootanimation/$(TARGET_BOOTANIMATION_NAME).zip:system/media/bootanimation.zip
endif
endif
...
ifdef hazy_BUILD_EXTRA
    hazy_POSTFIX := -$(hazy_BUILD_EXTRA)
endif
...
ifeq ($(hazy_BUILD_TYPE),DM)
    hazy_POSTFIX := -$(shell date +"%Y%m%d")
endif

ifndef hazy_POSTFIX
    hazy_POSTFIX := -$(shell date +"%Y%m%d-%H%M")
endif

PLATFORM_VERSION_CODENAME := $(hazy_BUILD_TYPE)

# Set all versions
hazy_VERSION := hazy-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(hazy_BUILD_TYPE)$(hazy_POSTFIX)
hazy_MOD_VERSION := hazy-$(hazy_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(hazy_BUILD_TYPE)$(hazy_POSTFIX)
